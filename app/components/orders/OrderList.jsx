              ...
              <div className="overflow-hidden shadow ring-1 ring-black ring-opacity-5 rounded-lg">
                <table className="min-w-full divide-y divide-gray-300">
                  <thead className="bg-gradient-to-r from-gray-50 to-gray-100">
                    <tr>
                      <th scope="col" className="py-4 pl-4 pr-3 text-left text-sm font-semibold text-gray-900 sm:pl-6">판매사이트</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">주문번호</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">상품코드</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">상품명</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">수량</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">전체 판매가</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">수취인</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">우편번호</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">주소</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">연락처</th>
                      <th scope="col" className="px-3 py-4 text-left text-sm font-semibold text-gray-900">판매단가</th>
                    </tr>
                  </thead>
                    ...
                    {displayOrders.map((order, index) => {
                      ...
                      return (
                        <tr key={`${order.reference_no}-${index}`} className="hover:bg-blue-50 transition-colors">
                          ...
                          <td className="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{order.reference_no}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{order.sku}</td>
                          <td className="px-3 py-4 text-sm text-gray-900">
                            <div className="whitespace-pre-line font-medium">{order.product_name}</div>
                            {order.original_product_name && order.original_product_name !== order.product_name && (
                              <div className="text-gray-500 whitespace-pre-line text-xs mt-1">{order.original_product_name}</div>
                            )}
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{order.quantity}</td>
                          <td className={`whitespace-nowrap px-3 py-4 text-sm font-semibold ${isHighValue ? 'text-red-600' : 'text-gray-900'}`}>
                            {totalValue.toLocaleString()}
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm">
                            <div className="font-medium text-gray-900">{order.consignee_name}</div>
                            <div className="text-gray-500 text-xs mt-1">{order.kana}</div>
                          </td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{order.post_code}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{order.address}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm text-gray-600">{order.phone_number}</td>
                          <td className="whitespace-nowrap px-3 py-4 text-sm font-medium text-gray-900">{order.unit_value?.toLocaleString()}</td>
                        </tr>
                      );
                    })}
                  </tbody>
